<template>
  <div>
    ...
    <div>
      ...
      <el-button @click="handleCreate" type="primary" class="confirm">
        创建课程实例
      </el-button>
    </div>
  </div>
  ...
  beforeRouteEnter(to, from, next) {
    ...
    next(vm=>{          
      if(from.name === 'courseInfo'){
        vm.courseName=vm.$route.params.course.title;
        vm.courseCode=vm.$route.params.course.code;
        vm.nature=vm.$route.params.course.nature;
        vm.credit=vm.$route.params.course.credit;
        vm.totalHours=vm.$route.params.course.totalHours;
        vm.assessment=vm.$route.params.course.assessment;
        if(vm.$route.params.isAdd === true){
          console.log('addSuccess')
        }
        else{
          vm.courseInfoName=vm.$route.params.courseInstance.name;
          vm.semeter=vm.$route.params.courseInstance.semeter;
          vm.weekday=vm.$route.params.courseInstance.weekday;
          vm.startTime=vm.$route.params.courseInstance.startTime;
          vm.endTime=vm.$route.params.courseInstance.endTime;
          vm.book=vm.$route.params.courseInstance.book;
          vm.resource=vm.$route.params.courseInstance.resource;
